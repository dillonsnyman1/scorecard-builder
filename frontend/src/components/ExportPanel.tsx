              ...
              <div className="table-wrapper">
                <table className="data-table compact">
                  ...
                  <tbody>
                    ...
                    {stabilityData.cyclicality.first_diff !== undefined && (<tr><td>First-diff regression (PRA c)</td><td className="mono">{stabilityData.cyclicality.first_diff.toFixed(4)}</td><td>{Math.abs(stabilityData.cyclicality.first_diff) > 1 ? "Amplifies cycle" : Math.abs(stabilityData.cyclicality.first_diff) > 0.3 ? "Partially PIT" : Math.abs(stabilityData.cyclicality.first_diff) > 0 ? "Within PRA expectation" : "No sensitivity"}</td></tr>)}
